...
from py_neuromodulation import FieldTrip, nm_stream_abc


class RealTimePyNeuro(nm_stream_abc.PNStream):
    ...
    def _get_data(
        self, queue_raw: multiprocessing.Queue, ftc: FieldTrip.Client
    ) -> np.array:
        def on_press(key):
    ...
    def sendFeatures(
        self, queue_features: multiprocessing.Queue, ftc: FieldTrip.Client
    ):
