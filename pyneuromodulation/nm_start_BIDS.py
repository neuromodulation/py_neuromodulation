...
class NM_BIDS:
    def __init__(
        ...
        self.set_settings(
            self.PATH_SETTINGS, PATH_BIDS=PATH_BIDS, PATH_OUT=PATH_OUT
        )
    ...
    def set_settings(self, PATH_SETTINGS=None, PATH_BIDS=None, PATH_OUT=None):
        if PATH_SETTINGS is None:
            ...
            PATH_SETTINGS = os.path.join(
                os.path.dirname(nm_IO.__file__), "nm_settings.json"
            )
            ...
            self.settings_wrapper = nm_settings.SettingsWrapper(
                settings_path=self.PATH_SETTINGS
            )
    ...
    def set_annotations(self):
        try:
            self.annot = mne.read_annotations(
                os.path.join(
            ...
            self.raw_arr_data = self.raw_arr.get_data(
    ...
    def set_nm_channels(self, PATH_NM_CHANNELS=None):
        ...
        self.settings_wrapper.set_nm_channels(
            nm_channels_path=self.PATH_NM_CHANNELS,
    ...
    def set_generator(self):
        ...
        self.gen = nm_generator.ieeg_raw_generator(
            self.raw_arr_data, self.settings_wrapper.settings
        )
    ...
    def set_rereferencing(self):
        ...
        if self.settings_wrapper.settings["methods"]["re_referencing"] is True:
            ...
            self.settings_wrapper.nm_channels[
                "new_name"
            ] = self.settings_wrapper.nm_channels["name"]
    ...
    def set_resampling(self):
        ...
        if self.settings_wrapper.settings["methods"]["raw_resampling"] is True:
            self.resample = nm_resample.Resample(
    ...
    def set_features(self):
        ...
        self.features = nm_features.Features(
            self.settings_wrapper.settings, verbose=self.verbose
        )
    ...
    def save_features(self):
        ...
        self.run_analysis.feature_arr = (
            self.df_features
        )  # here the potential label stream is added
        nm_IO.save_features_and_settings(
            df_=self.df_features,
