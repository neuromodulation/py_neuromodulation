...
def main():
    ...
    for f in files:
        ...
        epoch_stream.feature_arr["label_" + label_encoder.classes_[0]] = label_arr[:, 0]
        epoch_stream.feature_arr["label_" + label_encoder.classes_[1]] = label_arr[:, 1]
        epoch_stream.feature_arr["label_" + label_encoder.classes_[2]] = label_arr[:, 2]

        epoch_stream.feature_arr["label"] = labels
        ...
        epoch_stream.save_after_stream(file_name)
