...
def run_example_BIDS():
    ...
    # changes types to eeg and putting some channel to reref = None
    nm_channels.iloc[nm_channels.query("type == 'ecog'").index, nm_channels.columns.get_loc("type")] = "eeg"

    nm_channels.iloc[nm_channels.query("type == 'eeg'").index[:3], nm_channels.columns.get_loc("rereference")] = "None"
