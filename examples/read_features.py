...
nm_reader = nm_reader.NM_Reader(PATH_FEATURES)
folder_ = os.listdir(PATH_FEATURES)[0]
...
label_name = nm_reader.df_M1.iloc[np.where(nm_reader.df_M1["target"])[0][0]]["name"]
...
nm_reader.plot_corr_matrix(feature_files[0])
nm_reader.plot_epochs_avg(feature_files[0])
