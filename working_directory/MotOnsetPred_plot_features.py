...
def run_feature_plot(feat_list, nm_reader_, sfreq_, time_beg, time_en, suffix_,
                     root):
    """"""
    for feature_file in feat_list:
        print("File: ", feature_file)
...
for suffix in suffixes[:]:
    ...
    classifiers = ['lda_oversample', 'lr_oversample', 'catboost_oversample',
                   ...
                   'lr_balance_weights', 'catboost_balance_weights',
    ...
    for feature_list, nm_reader in zip(feature_lists[:], nm_readers[:]):
        ...
        sfreq = 10
        run_feature_plot(
            feature_list, nm_reader, sfreq, time_begin, time_end, suffix,
            out_root)
