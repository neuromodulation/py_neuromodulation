...
deriv_root = os.path.join(root, 'derivatives', 'feat_no_norm')
nm_reader = NM_reader.NM_Reader(deriv_root)
feature_list = nm_reader.get_feature_list()
print(*feature_list, sep='\n')
new_root = r'C:\Users\richa\OneDrive - Charité - Universitätsmedizin Berlin\Berlin_ECOG_LFP_derivatives\pipeline-MotOnsetPred_2021-06-08'
out_root = os.path.join(new_root, 'derivatives', 'feat_no_norm')
...
deriv_root = os.path.join(root, 'derivatives', 'feat_no_norm')
new_root = r'C:\Users\richa\OneDrive - Charité - Universitätsmedizin Berlin\Beijing_ECOG_LFP_derivatives\pipeline-MotOnsetPred_2021-06-08'
out_root = os.path.join(new_root, 'derivatives', 'feat_no_norm')
nm_reader = NM_reader.NM_Reader(deriv_root)
#feature_list = nm_reader.get_feature_list()
#print(*feature_list, sep='\n')
