...
if __name__ == "__main__":
    ...
    for EXCLUDE_NIGHT_TIME in [True, False]:
        d_out = {}
        for CLASS in [True, False]:
            if EXCLUDE_NIGHT_TIME:
                df_all = df_all_[(df_all_["pkg_dt"].dt.hour >= 8) & (df_all_["pkg_dt"].dt.hour <= 20)].copy()
            else:
                df_all = df_all_.copy()
        ...
        SAVE_NAME = f"LOHO_ALL_LABELS_ALL_GROUPS_exludenight_{EXCLUDE_NIGHT_TIME}.pkl"
